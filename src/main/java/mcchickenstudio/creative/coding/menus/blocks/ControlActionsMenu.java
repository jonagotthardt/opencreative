...
public class ControlActionsMenu extends CodingBlockTypesMenu {

    public ControlActionsMenu(Player player, Location location) {
    ...
    protected Set<MenusCategory> getMenusCategories() {
        return ActionType.getMenusCategories(ActionCategory.CONTROL_ACTION);
    }
}