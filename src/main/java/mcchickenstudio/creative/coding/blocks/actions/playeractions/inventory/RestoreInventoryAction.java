...
public class RestoreInventoryAction extends PlayerAction {
    ...
    public void executePlayer(Player player) {
        player.getInventory().setContents(getPlot().getWorldPlayers().getPlotPlayer(player).getSavedInventory());
    }
