...
public class IncreaseNumberAction extends VariableAction {
    public IncreaseNumberAction(Executor executor, int x, Arguments args) {
    ...
    public ActionType getActionType() {
        return ActionType.VAR_INCREASE_NUMBER;
    }
}
