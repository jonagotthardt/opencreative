...
public enum ActionType {
   ...
   // PLAYER_SEND_COMPONENT(              ActionCategory.PLAYER_ACTION, MenusCategory.COMMUNICATION, null, new ArgumentSlot("")),
    ...
    // Movement
    PLAYER_TELEPORT(                    ActionCategory.PLAYER_ACTION, MenusCategory.MOVEMENT,      SendMessageAction.class, Material.ENDER_PEARL,  new ArgumentSlot("location",VariableType.LOCATION)),
     ...
     * Player Conditions.
     */
    PLAYER_IS_SNEAKING(                 ActionCategory.PLAYER_CONDITION, MenusCategory.STATE, IsSneakingCondition.class, Material.RABBIT);
    ...
    public final String getLocaleName() {
        String path = "items.developer.actions." + this.name().toLowerCase().replace("_","-") + ".name";
    ...
    public final ItemStack getIcon() {
        ItemStack icon = createItem(this.material, 1, "items.developer.actions." + this.name().toLowerCase().replace("_","-"));
        if (isDisabled()) {
