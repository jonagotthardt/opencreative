...
public class HasResourcePackCondition extends PlayerCondition {
    /**
     ...
     */
    public HasResourcePackCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
