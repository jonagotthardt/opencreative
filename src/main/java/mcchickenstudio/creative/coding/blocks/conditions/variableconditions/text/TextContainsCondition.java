...
package mcchickenstudio.creative.coding.blocks.conditions.variableconditions.text;
...
public class TextContainsCondition extends VariableCondition {
    public TextContainsCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
    ...
    public boolean check(Entity entity) {
        ...
        String contains = getArguments().getValue("contains","",this);
        ...
        if (ignoreColors) {
            ...
            contains = ChatColor.stripColor(contains);
        }
        if (ignoreCaps) {
