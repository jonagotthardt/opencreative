...
package mcchickenstudio.creative.coding.blocks.conditions.entityconditions;
...
public abstract class EntityCondition extends Condition {
    ...
    public EntityCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
