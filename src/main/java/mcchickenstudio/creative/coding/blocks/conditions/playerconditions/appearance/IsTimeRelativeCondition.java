...
public class IsTimeRelativeCondition extends PlayerCondition {
    /**
     ...
     */
    public IsTimeRelativeCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
