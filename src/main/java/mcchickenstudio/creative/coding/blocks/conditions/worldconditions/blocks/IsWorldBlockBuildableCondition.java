...
public class IsWorldBlockBuildableCondition extends WorldCondition {

    public IsWorldBlockBuildableCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
