...
package mcchickenstudio.creative.coding.blocks.conditions.variableconditions.location;
...
public class LocationInAreaCondition extends VariableCondition {
    public LocationInAreaCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
