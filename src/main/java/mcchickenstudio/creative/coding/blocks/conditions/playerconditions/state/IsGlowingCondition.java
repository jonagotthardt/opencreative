...
public class IsGlowingCondition extends PlayerCondition {
    /**
     ...
     */
    public IsGlowingCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
