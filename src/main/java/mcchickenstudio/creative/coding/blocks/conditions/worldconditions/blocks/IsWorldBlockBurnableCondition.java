...
public class IsWorldBlockBurnableCondition extends WorldCondition {

    public IsWorldBlockBurnableCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
