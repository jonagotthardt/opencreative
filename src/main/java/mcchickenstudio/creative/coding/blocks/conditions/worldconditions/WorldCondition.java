...
package mcchickenstudio.creative.coding.blocks.conditions.worldconditions;
...
public abstract class WorldCondition extends Condition {
    ...
    public WorldCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
