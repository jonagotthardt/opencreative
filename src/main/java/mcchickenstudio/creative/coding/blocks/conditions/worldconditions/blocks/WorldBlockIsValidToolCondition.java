...
public class WorldBlockIsValidToolCondition extends WorldCondition {

    public WorldBlockIsValidToolCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
