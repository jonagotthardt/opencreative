...
public class IsWorldBlockEmptyCondition extends WorldCondition {

    public IsWorldBlockEmptyCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
