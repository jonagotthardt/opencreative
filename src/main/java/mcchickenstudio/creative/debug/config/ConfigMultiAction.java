...
public class ConfigMultiAction extends ConfigAction {

    protected final List<ConfigAction> actions = new ArrayList<>();

    ConfigMultiAction(ActionCategory category, ActionType type) {
        super(category, type);
    }
