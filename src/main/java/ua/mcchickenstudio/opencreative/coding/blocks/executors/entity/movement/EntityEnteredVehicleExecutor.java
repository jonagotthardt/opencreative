...
public class EntityEnteredVehicleExecutor extends EntityExecutor {

    public EntityEnteredVehicleExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_ENTERED_VEHICLE;
    }
