...
public class EntityRemovedExecutor extends EntityExecutor {

    public EntityRemovedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_REMOVED;
    }
