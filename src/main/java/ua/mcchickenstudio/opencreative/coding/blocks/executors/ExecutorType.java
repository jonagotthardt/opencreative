...
public enum ExecutorType {
    ...
    WORLD_BLOCK_LEAVES_DECAYED( ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockLeavesDecayedExecutor.class, BlockLeavesDecayedEvent.class, Material.OAK_LEAVES),
    WORLD_BLOCK_NOTE_PLAYED(    ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockNotePlayedExecutor.class, BlockNotePlayedEvent.class, Material.NOTE_BLOCK),
    WORLD_BLOCK_SCULK_BLOOMED(  ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockSculkBloomedExecutor.class, BlockSculkBloomedEvent.class, Material.SCULK_SENSOR),
    ...
    WORLD_BLOCK_ANVIL_DAMAGED(  ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockAnvilDamagedExecutor.class, BlockAnvilDamagedEvent.class, Material.DAMAGED_ANVIL),
    WORLD_BLOCK_TARGET_HIT(     ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockTargetHitExecutor.class, BlockTargetHitEvent.class, Material.TARGET),
    WORLD_BLOCK_SPONGE_ABSORBED(ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockSpongeAbsorbedExecutor.class, BlockSpongeAbsorbedEvent.class, Material.WET_SPONGE),
    WORLD_BLOCK_BELL_RUNG(      ExecutorCategory.EVENT_WORLD, MenusCategory.BLOCKS, BlockBellRungExecutor.class, BlockBellRungEvent.class, Material.BELL),
