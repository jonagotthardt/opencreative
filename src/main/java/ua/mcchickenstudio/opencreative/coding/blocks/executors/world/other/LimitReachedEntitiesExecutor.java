...
public class LimitReachedEntitiesExecutor extends WorldExecutor {

    public LimitReachedEntitiesExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.WORLD_REACHED_ENTITIES_LIMIT;
    }
}
