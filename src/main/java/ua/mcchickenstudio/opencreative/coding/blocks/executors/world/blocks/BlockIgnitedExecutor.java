...
public class BlockIgnitedExecutor extends WorldExecutor implements Cancellable {

    public BlockIgnitedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }
    ...
    public ExecutorType getExecutorType() {
        return ExecutorType.WORLD_BLOCK_IGNITED;
    }
