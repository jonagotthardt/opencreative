...
public class EntityExplodedExecutor extends EntityExecutor {

    public EntityExplodedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_EXPLODED;
    }
