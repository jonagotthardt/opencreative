...
public class EntityVehicleExitExecutor extends EntityExecutor {

    public EntityVehicleExitExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_VEHICLE_EXIT;
    }
