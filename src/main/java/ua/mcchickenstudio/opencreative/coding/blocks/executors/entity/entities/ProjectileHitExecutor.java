...
public class ProjectileHitExecutor extends EntityExecutor {

    public ProjectileHitExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_PROJECTILE_HIT;
    }
