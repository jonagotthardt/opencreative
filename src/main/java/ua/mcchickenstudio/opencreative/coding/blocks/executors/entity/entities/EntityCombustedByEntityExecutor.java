...
public class EntityCombustedByEntityExecutor extends EntityExecutor {

    public EntityCombustedByEntityExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_COMBUSTED_BY_ENTITY;
    }
