...
public class HangingBreakExecutor extends EntityExecutor {

    public HangingBreakExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public @NotNull ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_HANGING_BREAK;
    }
