...
public class SlimeSplittedExecutor extends EntityExecutor {

    public SlimeSplittedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_SLIME_SPLIT;
    }
