...
public class IsGlidingCondition extends PlayerCondition {
    /**
     ...
     */
    public IsGlidingCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
