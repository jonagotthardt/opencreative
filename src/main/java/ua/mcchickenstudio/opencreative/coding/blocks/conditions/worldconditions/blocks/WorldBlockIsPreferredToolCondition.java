...
public class WorldBlockIsPreferredToolCondition extends WorldCondition {

    public WorldBlockIsPreferredToolCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
