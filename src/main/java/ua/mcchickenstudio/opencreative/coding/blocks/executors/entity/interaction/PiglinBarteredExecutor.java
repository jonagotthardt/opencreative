...
public class PiglinBarteredExecutor extends EntityExecutor {

    public PiglinBarteredExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_PIGLIN_BARTERED;
    }
