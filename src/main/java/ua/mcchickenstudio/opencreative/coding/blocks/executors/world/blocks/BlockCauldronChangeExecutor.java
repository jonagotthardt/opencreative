...
public class BlockCauldronChangeExecutor extends WorldExecutor {

    public BlockCauldronChangeExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }
    ...
    public ExecutorType getExecutorType() {
        return ExecutorType.WORLD_BLOCK_CAULDRON_CHANGE;
    }
