...
public class EntityDismountedExecutor extends EntityExecutor {

    public EntityDismountedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }

    @Override
    public ExecutorType getExecutorType() {
        return ExecutorType.ENTITY_DISMOUNTED;
    }
