...
public enum ActionType {
 ...
 /**
    ...
    WORLD_SPAWN_EYE_OF_ENDER(                 ActionCategory.WORLD_ACTION, MenusCategory.ENTITY, SpawnEnderEyeAction.class, Material.ENDER_EYE, new ArgumentSlot("locations", ValueType.LOCATION, (byte) 18), new ArgumentSlot("name", ValueType.TEXT), new ParameterSlot("drop"), new ArgumentSlot("damage", ValueType.NUMBER)),
    ...
    ENTITY_SET_VISUAL_FIRE(             ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetVisualFireAction.class, Material.CAMPFIRE,  new ParameterSlot("boolean")),
    ENTITY_SET_GLOWING(                 ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetGlowingAction.class, Material.DRAGON_BREATH,  new ParameterSlot("glowing", Arrays.asList(false,true), Material.WHITE_STAINED_GLASS, Material.GLASS)),
    ...
    ENTITY_SET_SHEEP_COLOR(             ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetSheepColorAction.class, Material.SHEEP_SPAWN_EGG, new ParameterSlot("color", List.of("white","light-gray","gray","black","red","orange","yellow","lime","green","light-blue","cyan","blue","purple","magenta","pink","brown"), Material.WHITE_DYE, Material.LIGHT_GRAY_DYE, Material.GRAY_DYE, Material.BLACK_DYE, Material.RED_DYE, Material.ORANGE_DYE, Material.YELLOW_DYE, Material.LIME_DYE, Material.GREEN_DYE, Material.LIGHT_BLUE_DYE, Material.CYAN_DYE, Material.BLUE_DYE, Material.PURPLE_DYE, Material.MAGENTA_DYE, Material.PINK_DYE, Material.BROWN_DYE)),
    ENTITY_SET_PARROT_COLOR(             ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetParrotColorAction.class, Material.PARROT_SPAWN_EGG, new ParameterSlot("color", List.of("red","blue","green","cyan","gray"), Material.RED_DYE, Material.BLUE_DYE, Material.GREEN_DYE, Material.CYAN_DYE, Material.GRAY_DYE)),
    ENTITY_SET_DOG_COLLAR_COLOR(        ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetDogCollarColorAction.class, Material.WOLF_SPAWN_EGG, new ParameterSlot("color", List.of("white","light-gray","gray","black","red","orange","yellow","lime","green","light-blue","cyan","blue","purple","magenta","pink","brown"), Material.WHITE_DYE, Material.LIGHT_GRAY_DYE, Material.GRAY_DYE, Material.BLACK_DYE, Material.RED_DYE, Material.ORANGE_DYE, Material.YELLOW_DYE, Material.LIME_DYE, Material.GREEN_DYE, Material.LIGHT_BLUE_DYE, Material.CYAN_DYE, Material.BLUE_DYE, Material.PURPLE_DYE, Material.MAGENTA_DYE, Material.PINK_DYE, Material.BROWN_DYE)),
    ...
    ENTITY_SET_SCREAMING(           ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetScreamingAction.class,     Material.ENDERMAN_SPAWN_EGG,    new ParameterSlot("boolean")),
    ENTITY_SET_GOAT_HORNS(          ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetGoatHornsAction.class,     Material.GOAT_HORN,             new ParameterSlot("left"), new ParameterSlot("right")),
    ENTITY_SET_FOX_FACEPLANTED(     ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetFoxFaceplantedAction.class,Material.FOX_SPAWN_EGG,         new ParameterSlot("boolean")),
    ENTITY_SET_FOX_DEFENDING(       ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetFoxDefendingAction.class,  Material.FOX_SPAWN_EGG,         new ParameterSlot("boolean")),
    ENTITY_SET_FOX_CROUCHING(       ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetFoxCrouchingAction.class,  Material.FOX_SPAWN_EGG,         new ParameterSlot("boolean")),
    ...
    ENTITY_SET_PANDA_ON_BACK(       ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetPandaOnBackAction.class,   Material.PANDA_SPAWN_EGG,       new ParameterSlot("boolean")),
    ...
    ENTITY_SET_BEAR_STANDING(       ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetBearStandingAction.class,  Material.POLAR_BEAR_SPAWN_EGG,  new ParameterSlot("boolean")),
    ENTITY_SET_ALLAY_DANCING(       ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetAllayDancingAction.class,  Material.ALLAY_SPAWN_EGG,       new ParameterSlot("boolean"), new ArgumentSlot("jukebox", ValueType.LOCATION)),
    ...
    ENTITY_VILLAGER_SHAKE_HEAD(     ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntityVillagerShakeHeadAction.class,Material.VILLAGER_SPAWN_EGG),
    ...
    ENTITY_SET_PIGLIN_DANCING(      ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetPiglinDancingAction.class,           Material.PIGLIN_HEAD,           new ParameterSlot("boolean"), new ArgumentSlot("time", ValueType.NUMBER)),
    ENTITY_SET_CELEBRATING(         ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetPillagerCelebratingAction.class,     Material.PILLAGER_SPAWN_EGG, new ParameterSlot("boolean")),
