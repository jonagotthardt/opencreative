...
public enum ActionType {
 ...
 /**
    ...
    ENTITY_SET_SHEEP_COLOR(             ActionCategory.ENTITY_ACTION, MenusCategory.STATE, EntitySetSheepColorAction.class, Material.SHEEP_SPAWN_EGG, new ParameterSlot("color", List.of("white","light-gray","gray","black","red","orange","yellow","lime","light-green","light-blue","cyan","blue","purple","magenta","pink","brown"), Material.WHITE_DYE, Material.LIGHT_GRAY_DYE, Material.GRAY_DYE, Material.BLACK_DYE, Material.RED_DYE, Material.ORANGE_DYE, Material.YELLOW_DYE, Material.LIME_DYE, Material.GREEN_DYE, Material.LIGHT_BLUE_DYE, Material.CYAN_DYE, Material.BLUE_DYE, Material.PURPLE_DYE, Material.MAGENTA_DYE, Material.PINK_DYE, Material.BROWN_DYE)),
    ENTITY_SET_DOG_COLLAR_COLOR(        ActionCategory.ENTITY_ACTION, MenusCategory.STATE, EntitySetDogCollarColorAction.class, Material.WOLF_SPAWN_EGG, new ParameterSlot("color", List.of("white","light-gray","gray","black","red","orange","yellow","lime","light-green","light-blue","cyan","blue","purple","magenta","pink","brown"), Material.WHITE_DYE, Material.LIGHT_GRAY_DYE, Material.GRAY_DYE, Material.BLACK_DYE, Material.RED_DYE, Material.ORANGE_DYE, Material.YELLOW_DYE, Material.LIME_DYE, Material.GREEN_DYE, Material.LIGHT_BLUE_DYE, Material.CYAN_DYE, Material.BLUE_DYE, Material.PURPLE_DYE, Material.MAGENTA_DYE, Material.PINK_DYE, Material.BROWN_DYE)),
