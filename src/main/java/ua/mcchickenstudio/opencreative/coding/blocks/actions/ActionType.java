...
public enum ActionType {
 ...
 /**
    ...
    VAR_NOISE_PERLIN( ActionCategory.VARIABLE_ACTION, MenusCategory.NUMBER_OPERATIONS, PerlinNoiseAction.class, Material.BEETROOT_SEEDS, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("location", ValueType.LOCATION), new ArgumentSlot("seed", ValueType.NUMBER), new ArgumentSlot("frequency", ValueType.NUMBER), new ArgumentSlot("octaves", ValueType.NUMBER), new ArgumentSlot("amplitude", ValueType.NUMBER), new ParameterSlot("normalize")),
    VAR_NOISE_SIMPLEX( ActionCategory.VARIABLE_ACTION, MenusCategory.NUMBER_OPERATIONS, SimplexNoiseAction.class, Material.PUMPKIN_SEEDS, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("location", ValueType.LOCATION), new ArgumentSlot("seed", ValueType.NUMBER), new ArgumentSlot("frequency", ValueType.NUMBER), new ArgumentSlot("octaves", ValueType.NUMBER), new ArgumentSlot("amplitude", ValueType.NUMBER), new ParameterSlot("normalize")),
