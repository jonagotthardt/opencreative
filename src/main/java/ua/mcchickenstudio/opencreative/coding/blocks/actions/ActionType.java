...
public enum ActionType {
 ...
 /**
    ...
    VAR_CHAR_FROM_CODE_POINT( ActionCategory.VARIABLE_ACTION, MenusCategory.TEXT_OPERATIONS, CharFromCodePointAction.class, Material.GOLD_NUGGET, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("code-point", ValueType.NUMBER)),
