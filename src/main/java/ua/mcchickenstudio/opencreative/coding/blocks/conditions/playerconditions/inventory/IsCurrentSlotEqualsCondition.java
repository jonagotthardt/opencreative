...
public class IsCurrentSlotEqualsCondition extends PlayerCondition {

    public IsCurrentSlotEqualsCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
