...
public class BlockFadedExecutor extends WorldExecutor implements Cancellable {

    public BlockFadedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }
    ...
    public ExecutorType getExecutorType() {
        return ExecutorType.WORLD_BLOCK_FADED;
    }
