...
public class BlockPistonRetractedExecutor extends WorldExecutor implements Cancellable {

    public BlockPistonRetractedExecutor(Planet planet, int x, int y, int z) {
        super(planet, x, y, z);
    }
    ...
    public ExecutorType getExecutorType() {
        return ExecutorType.WORLD_BLOCK_PISTON_RETRACTED;
    }
