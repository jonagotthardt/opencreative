...
public class NumberGreaterCondition extends VariableCondition {
    public NumberGreaterCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, boolean isOpposed) {
