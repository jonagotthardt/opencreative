...
public class WorldEventsMenu extends CodingBlockTypesMenu {

    public WorldEventsMenu(Player player, Location location) {
        super(player, location, "events","event_world");
    }
    ...
    protected Set<MenusCategory> getMenusCategories() {
        return ExecutorType.getMenusCategories(ExecutorCategory.EVENT_WORLD);
    }
}