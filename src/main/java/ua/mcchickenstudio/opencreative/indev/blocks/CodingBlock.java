...
public abstract class CodingBlock implements ConfigurationSerializable {
    ...
    public CodingBlock(@NotNull String id, @NotNull Material mainBlock, @NotNull Material offBlock, boolean hasContainer) {
