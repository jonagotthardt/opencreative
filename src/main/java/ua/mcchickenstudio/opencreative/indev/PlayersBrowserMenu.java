...
*/
/**
 * This class represents a menus, that displays specified list of online players in world.
 * Owner can change players permissions, kick or even ban.
 *//*

public final class PlayersBrowserMenu extends ListBrowserMenu<Entity> {

    private final Planet planet;
    private final List<ParameterButton> buttons = new ArrayList<>();

    private final ItemStack KICK_FROM_WORLD = createItem(Material.STRUCTURE_VOID,1,"menus.entities-browser.items.remove-all");
    private final ItemStack BAN_FROM_WORLD = createItem(Material.BARRIER,1,"menus.entities-browser.items.remove-all");
